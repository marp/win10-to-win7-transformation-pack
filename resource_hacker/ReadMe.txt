...
This Resource Hacker™ software is released as freeware provided that you agree to the following terms and conditions: 
  1. This software is not used for purposes that will infringe third-party license agreements.
  2. This software may only be redistributed under the following conditions:
    a. It is redistributed in its entirety, either in ZIP or setup EXE formats.
    b. It is not bundled with software that will likely infringe third-party license agreements.
